...
const SETTINGS_CARD_CLASS =
  'rounded-2xl border border-slate-800/80 bg-slate-950 p-4 shadow-lg shadow-black/20 transition-colors hover:border-cyan-500/40 focus-within:border-cyan-500/40';

const SETTINGS_LABEL_CLASS =
  'text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-400';

const SETTINGS_CONTROL_CLASS =
  'flex h-12 items-center rounded-xl border border-slate-700/70 bg-slate-900/80 px-3 transition-colors hover:border-cyan-500/40 hover:bg-slate-900 focus-within:border-cyan-500 focus-within:bg-slate-900 focus-within:ring-2 focus-within:ring-cyan-500/20';

const SETTINGS_INPUT_CLASS =
  'h-auto border-none bg-transparent p-0 text-base font-semibold text-[#6CA6C1] shadow-none outline-none placeholder:text-slate-600 focus-visible:ring-0';

const SETTINGS_SELECT_TRIGGER_CLASS =
  'h-12 w-full rounded-xl border-slate-700/70 bg-slate-900/80 font-mono text-sm font-medium text-[#6CA6C1] transition-all duration-200 hover:border-cyan-500/40 hover:bg-slate-900 focus:ring-2 focus:ring-cyan-500/20 data-[state=open]:border-cyan-500 data-[state=open]:bg-slate-900 [&_svg]:text-cyan-300';

const SETTINGS_SELECT_CONTENT_CLASS =
  'rounded-xl border border-slate-800 bg-slate-950 font-mono text-[#6CA6C1] shadow-2xl shadow-black/40';

const SETTINGS_SELECT_ITEM_CLASS = "cursor-pointer rounded-lg font-mono text-sm !text-[#6CA6C1] hover:bg-slate-800 hover:!text-white data-highlighted:!text-white "
// const SETTINGS_SELECT_ITEM_CLASS = 'cursor-pointer rounded-lg font-mono text-sm !text-slate-100 hover:bg-slate-800 hover:!text-white focus:bg-slate-800 focus:!text-white data-[highlighted]:bg-slate-800 data-[highlighted]:!text-white data-[state=checked]:bg-cyan-500/10 data-[state=checked]:!text-cyan-200 [&_svg]:!text-cyan-300';
...
export default function PayrollProPage() {
  ...
  return (
    <div className="min-h-screen bg-[#343434] p-6 font-mono text-slate-100">
      <div className="mx-auto max-w-[1700px] space-y-6">
                ...
                <Field className="space-y-3">
                  ...
                  <div className={SETTINGS_CONTROL_CLASS}>
                    <Input
                      ...
                      className={SETTINGS_INPUT_CLASS}
                    />
                    <span className="ml-3 text-sm font-bold text-slate-500">%</span>
                  </div>
                </Field>
              </div>
            ))}
          ...
          <div className="grid gap-4 border-t border-slate-800 p-6 md:grid-cols-3">
            ...
            <div className={SETTINGS_CARD_CLASS}>
              <Field className="space-y-3">
                ...
                <div className={SETTINGS_CONTROL_CLASS}>
                  <span className="mr-3 text-sm font-bold text-slate-500">Rp</span>
                  <Input
                    id="plafon-jp"
                    type="number"
        ...
        <section className="grid gap-6 lg:grid-cols-4">
          <div className="flex items-center justify-between rounded-2xl bg-indigo-600 p-6 lg:col-span-2">
            ...
            <Input type='file' accept=".xlsx,.xls" onChange={handleExcel} className="text-xs file:rounded-lg file:border-0 file:bg-white file:px-4 file:py-5 file:font-black file:text-indigo-600 border-none" />
          </div>
          <div className={SETTINGS_CARD_CLASS}>
            <Field className="space-y-3">
              <FieldLabel className={SETTINGS_LABEL_CLASS}>
